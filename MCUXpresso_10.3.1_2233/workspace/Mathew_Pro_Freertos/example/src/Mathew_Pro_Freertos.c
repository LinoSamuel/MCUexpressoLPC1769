...
unsigned portBASE_TYPE U1,U2,uxPriority;
 ...
 * Private functions
 ****************************************************************************/
unsigned portBASE_TYPE xTask2Handle = NULL;
unsigned portBASE_TYPE xTask3Handle = NULL;
...
static void vLEDTask3(void *pvParameters) {
	...
	while (1) {
		...
		printf("\n Task 3 is running");
		uxPriority = uxTaskPriorityGet( NULL );
						vTaskPrioritySet( NULL, ( uxPriority -4  ) );
				vTaskDelay(configTICK_RATE_HZ*2);
				Board_LED_Set(1, true);
				Board_LED_Set(2, true);
				printf("\n Task 3 completed running");
